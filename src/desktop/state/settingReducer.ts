...
export const REDUX_ACTION_UPDATE_USERS_GROUP = "REDUX_ACTION_UPDATE_USERS_GROUP";
export const REDUX_ACTION_UPDATE_ADMIN_USERS_LIST = "REDUX_ACTION_UPDATE_ADMIN_USERS_LIST";
export const REDUX_ACTION_UPDATE_ADMIN_RIGHT_MODULE = "REDUX_ACTION_UPDATE_ADMIN_RIGHT_MODULE";
